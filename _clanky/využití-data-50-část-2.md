...
{% include image.html
   url="../attachments/články/využití-data-50/OP_zakaz_staveb.png"
...
{% include image.html
   url="../attachments/články/využití-data-50/OP_vyskove_omezeni_staveb.png"
...
{% include image.html
   url="../attachments/články/využití-data-50/OP_vzlet.png"
...
Definice drah z Leteckého předpisu lze převést do matematických rovnic. Jedinými proměnnými jsou souřadnice koncových bodů osy dráhy a kódové číslo letiště. Matematické rovnice byly zapsány v jazyce Octave. Výstupem ze skriptu jsou soubory ve formátu CSV obsahující geometrii polygonů vyjádřených pomocí Well-Known Text (WKT) zápisu i s jejich nadmořskou výšku (jako třetí souřadnice každého lomového bodu). Jeden z lichoběžníkových polygonů Letiště Václava Havla je v CSV vyjádřen následovně:
...
{% include image.html
   url="../attachments/články/využití-data-50/add_csv.png"
...
{% include image.html
   url="../attachments/články/využití-data-50/v.in.ogr.png"
...
{% include image.html
   url="../attachments/články/využití-data-50/v.to.rast.attr.png"
...
{% include image.html
   url="../attachments/články/využití-data-50/v.surf.contour.png"
...
{% include image.html
   url="../attachments/články/využití-data-50/v.surf.contour-output.png"
...
{% include image.html
   url="../attachments/články/využití-data-50/r.out.gdal.gtiff.png"
