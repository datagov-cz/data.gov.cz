...
layout: post
icon: whatshot
title: Proběhl “Linked Open Data” workshop
detail: true
ref: lodworkshop2018
lang: cs
author: michal_kubáň
...
<!--more-->
Workshopu se zúčastnilo 21 účastníků z vybraných  zemí EU, tj. Česka, Polska, Slovinska, Slovenska, Irska, Belgie, Lucemburska, Německa a Nizozemí. Na workshopu vystoupily zástupce těchto organizací: MV ČR, Úřad Publikace EU (Evropská komise), European Data Portal, Fraunhofer FOKUS, Central Statistical Office Ireland.
</p>
...
<p>
Následovala sekce, ve které členové týmu projektu “Implementace strategií v oblasti otevřených dat II” popsali aktuální stav a výhled aktivit v oblasti otevřených propojených dat v ČR. Martin Nečaský <a href="/assets/2018-12-19/LOD in the Czech Republic.pdf">informoval účastníky workshopu o otevřených datech, která již jsou publikována jako otevřená propojená data</a>. Jedná se o data České správy sociálního zabezpečení a Generálního finančního ředitelství. Zdůraznil však, že současné aktivity probíhají bez širší koncepce, která by uvažovala celý prostor otevřených dat veřejné správy. Přitom až právě na této úrovni se mohou přínosy otevřených propojených dat projevit. Nastínil, jaké problémy přináší současné způsoby publikace dat a jak je efektivně vyřeší aplikace principů otevřených propojených dat. V následující prezentaci ukázal Petr Křemen, <a href="/assets/2018-12-19/Semantic Government Vocabulary.pdf">jak je možné zlepšit interoperabilitu otevřených dat<a/> díky lepším popisům dat pomocí konceptuálních datových modelů a sémantických slovníků budovaných pomocí metod ontologického inženýrství a otevřených propojených dat. Nastínil budoucí plán implementovat modely a slovníky do Národního katalogu otevřených dat a tím uživatelsky přívětivou formou zlepšit vyhledatelnost datových sad na základě sémantických souvislostí. Posledním v sekci byl Jakub Klímek, který představil <a href="/assets/2018-12-19/LOD in Czech Open Data Portal.pdf">nové řešení Národního katalogu otevřených dat</a> založeného na EU standardu DCAT-AP pro katalogizaci otevřených dat. Zdůraznil, že český národní katalog je prvním katalogem v EU s plnou a nativní podporou tohoto standardu a že celé řešení národního katalogu je postaveno na open-source technologiích.
</p>
...
<ul>
    <li>Jak můžeme zlepšit způsoby prezentace dat?</li>
    <li>Jaké jsou možné nové funkcionality datových katalogů?</li>
    <li>Jak lze zlepšit kvalitu otevřených dat?</li>
</ul>
</p>
...
<ul>
    <li>Otevřená propojená data zatím nejsou široce akceptována jak poskytovateli tak konzumenty otevřených dat a chybí motivace s tímto novým způsobem experimentovat.</li>
    <li>Motivací by mohly být nové funkcionality datových portálů, které nelze bez otevřených propojených dat vybudovat:
        <ul>        
            <li>vyhledávání datových sad na základě sémantických souvislostí,</li>
            <li>vyhledávání datových sad poskytujících údaje o konkrétní entitě či s ní souvisejících entitách,</li>
            <li>vizualizace souvislostí mezi datovými sadami i entitami v nich obsaženými nebo</li>
            <li>poskytování datových API vystavěných nad jednotným konceptuálním datovým modelem napříč různými poskytovateli otevřených dat v dané zemi i v celé EU.</li>
        </ul>
    </li>
</ul>
</p>