...
* stupeň 1 - datová je dostupná v síti WWW s vhodnými podmínkami užití otevřených dat (viz [Jak stanovit podmínky užití datových sad?](/otevřená-data/pro-poskytovatele/stanovení-podmínek-užití/), 
